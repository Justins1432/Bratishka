...
public class OilForBeardStoreFragment extends Fragment {
    ...
    private RecyclerView recyclerViewOilProducts;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        root = inflater.inflate(R.layout.fragment_oil_for_beard_store, container, false);

        recyclerViewOilProducts = root.findViewById(R.id.recycler_view_oil_products);
        ...
        NetworkService.getInstance()
                ...
                .enqueue(new Callback<List<Product>>() {
                    ...
                    public void onResponse(Call<List<Product>> call, Response<List<Product>> response) {
                        ...
                        recyclerViewOilProducts.setLayoutManager(layoutManager);
                        recyclerViewOilProducts.setAdapter(new ShopAdapter(root.getContext(), products));
                    }
